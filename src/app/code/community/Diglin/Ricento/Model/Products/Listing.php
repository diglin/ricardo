 ...
 * @method int    getLangDeStoreId()
 * @method int    getLangFrStoreId()
 ...
 * @method Diglin_Ricento_Model_Products_Listing setLangDeStoreId(int $storeId)
 * @method Diglin_Ricento_Model_Products_Listing setLangFrStoreId(int $storeId)
